    ...
    internal class StubUpdateShardOperation : UpdateShardOperation
    {
        ...
        protected override ShardManagementErrorCategory ErrorCategory
        {
            get
            {
                ...
                return this.InstanceBehavior.Result<StubUpdateShardOperation, ShardManagementErrorCategory>(this, "get_ErrorCategory");
            }
        }
        ...
        protected override ShardLocation ErrorSourceLocation
        {
            get
            {
                ...
                return this.InstanceBehavior.Result<StubUpdateShardOperation, ShardLocation>(this, "get_ErrorSourceLocation");
            }
        }
        ...
        protected override ShardLocation ErrorTargetLocation
        {
            get
            {
                ...
                return this.InstanceBehavior.Result<StubUpdateShardOperation, ShardLocation>(this, "get_ErrorTargetLocation");
            }
        }
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateShardOperation>(this, "Dispose");
        }
        ...
        public override IStoreResults DoGlobalPostLocalExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateShardOperation, IStoreResults>(this, "DoGlobalPostLocalExecute");
        }
        ...
        public override void DoGlobalPostLocalUpdateCache(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateShardOperation>(this, "DoGlobalPostLocalUpdateCache");
        }
        ...
        public override IStoreResults DoGlobalPreLocalExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateShardOperation, IStoreResults>(this, "DoGlobalPreLocalExecute");
        }
        ...
        public override IStoreResults DoLocalSourceExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateShardOperation, IStoreResults>(this, "DoLocalSourceExecute");
        }
        ...
        public override IStoreResults DoLocalTargetExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateShardOperation, IStoreResults>(this, "DoLocalTargetExecute");
        }
        ...
        public override StoreConnectionInfo GetStoreConnectionInfo()
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateShardOperation, StoreConnectionInfo>(this, "GetStoreConnectionInfo");
        }
        ...
        public override void HandleDoGlobalPostLocalExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateShardOperation>(this, "HandleDoGlobalPostLocalExecuteError");
        }
        ...
        public override void HandleDoGlobalPreLocalExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateShardOperation>(this, "HandleDoGlobalPreLocalExecuteError");
        }
        ...
        public override void HandleDoLocalSourceExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateShardOperation>(this, "HandleDoLocalSourceExecuteError");
        }
        ...
        public override void HandleDoLocalTargetExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateShardOperation>(this, "HandleDoLocalTargetExecuteError");
        }
        ...
        public override void HandleUndoGlobalPostLocalExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateShardOperation>(this, "HandleUndoGlobalPostLocalExecuteError");
        }
        ...
        public override void HandleUndoGlobalPreLocalExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateShardOperation>(this, "HandleUndoGlobalPreLocalExecuteError");
        }
        ...
        public override void HandleUndoLocalSourceExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateShardOperation>(this, "HandleUndoLocalSourceExecuteError");
        }
        ...
        public override void HandleUndoLocalTargetExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateShardOperation>(this, "HandleUndoLocalTargetExecuteError");
        }
        ...
        public override ShardManagementException OnStoreException(StoreException se, StoreOperationState state)
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateShardOperation, ShardManagementException>(this, "OnStoreException");
        }
        ...
        public override IStoreResults UndoGlobalPostLocalExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateShardOperation, IStoreResults>(this, "UndoGlobalPostLocalExecute");
        }
        ...
        public override IStoreResults UndoGlobalPreLocalExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateShardOperation, IStoreResults>(this, "UndoGlobalPreLocalExecute");
        }
        ...
        public override IStoreResults UndoLocalSourceExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateShardOperation, IStoreResults>(this, "UndoLocalSourceExecute");
        }
        ...
        public override IStoreResults UndoLocalTargetExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateShardOperation, IStoreResults>(this, "UndoLocalTargetExecute");
        }
    }
}
