...
{
    /// <summary>
    /// Stub type of Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement.UpdateMappingOperation
    /// </summary>
    [DebuggerDisplay("Stub of UpdateMappingOperation")]
    [DebuggerNonUserCode]
    internal class StubUpdateMappingOperation : UpdateMappingOperation
    {
        /// <summary>
        ...
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.DoGlobalPostLocalExecute(IStoreTransactionScope ts)
        /// </summary>
        internal Func<IStoreTransactionScope, IStoreResults> DoGlobalPostLocalExecuteIStoreTransactionScope;
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.DoGlobalPostLocalUpdateCache(IStoreResults result)
        /// </summary>
        internal Action<IStoreResults> DoGlobalPostLocalUpdateCacheIStoreResults;
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.DoGlobalPreLocalExecute(IStoreTransactionScope ts)
        /// </summary>
        internal Func<IStoreTransactionScope, IStoreResults> DoGlobalPreLocalExecuteIStoreTransactionScope;
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.DoLocalSourceExecute(IStoreTransactionScope ts)
        /// </summary>
        internal Func<IStoreTransactionScope, IStoreResults> DoLocalSourceExecuteIStoreTransactionScope;
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.DoLocalTargetExecute(IStoreTransactionScope ts)
        /// </summary>
        internal Func<IStoreTransactionScope, IStoreResults> DoLocalTargetExecuteIStoreTransactionScope;
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.get_ErrorCategory()
        /// </summary>
        public Func<ShardManagementErrorCategory> ErrorCategoryGet;
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.get_ErrorSourceLocation()
        /// </summary>
        public Func<ShardLocation> ErrorSourceLocationGet;
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.get_ErrorTargetLocation()
        /// </summary>
        public Func<ShardLocation> ErrorTargetLocationGet;
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.GetStoreConnectionInfo()
        /// </summary>
        internal Func<StoreConnectionInfo> GetStoreConnectionInfo01;
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.HandleDoGlobalPostLocalExecuteError(IStoreResults result)
        /// </summary>
        internal Action<IStoreResults> HandleDoGlobalPostLocalExecuteErrorIStoreResults;
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.HandleDoGlobalPreLocalExecuteError(IStoreResults result)
        /// </summary>
        internal Action<IStoreResults> HandleDoGlobalPreLocalExecuteErrorIStoreResults;
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.HandleDoLocalSourceExecuteError(IStoreResults result)
        /// </summary>
        internal Action<IStoreResults> HandleDoLocalSourceExecuteErrorIStoreResults;
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.HandleDoLocalTargetExecuteError(IStoreResults result)
        /// </summary>
        internal Action<IStoreResults> HandleDoLocalTargetExecuteErrorIStoreResults;
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.HandleUndoGlobalPostLocalExecuteError(IStoreResults result)
        /// </summary>
        ...
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.HandleUndoLocalSourceExecuteError(IStoreResults result)
        /// </summary>
        internal Action<IStoreResults> HandleUndoLocalSourceExecuteErrorIStoreResults;
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.HandleUndoLocalTargetExecuteError(IStoreResults result)
        /// </summary>
        ...
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.UndoGlobalPostLocalExecute(IStoreTransactionScope ts)
        /// </summary>
        ...
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.UndoLocalSourceExecute(IStoreTransactionScope ts)
        /// </summary>
        internal Func<IStoreTransactionScope, IStoreResults> UndoLocalSourceExecuteIStoreTransactionScope;
        /// <summary>
        /// Sets the stub of UpdateMappingOperation.UndoLocalTargetExecute(IStoreTransactionScope ts)
        /// </summary>
        ...
        protected override ShardManagementErrorCategory ErrorCategory
        {
            get
            {
                ...
                return this.InstanceBehavior.Result<StubUpdateMappingOperation, ShardManagementErrorCategory>(this, "get_ErrorCategory");
            }
        }
        ...
        protected override ShardLocation ErrorSourceLocation
        {
            get
            {
                ...
                return this.InstanceBehavior.Result<StubUpdateMappingOperation, ShardLocation>(this, "get_ErrorSourceLocation");
            }
        }
        ...
        protected override ShardLocation ErrorTargetLocation
        {
            get
            {
                ...
                return this.InstanceBehavior.Result<StubUpdateMappingOperation, ShardLocation>(this, "get_ErrorTargetLocation");
            }
        }
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "Dispose");
        }
        ...
        public override IStoreResults DoGlobalPostLocalExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateMappingOperation, IStoreResults>(this, "DoGlobalPostLocalExecute");
        }
        ...
        public override void DoGlobalPostLocalUpdateCache(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "DoGlobalPostLocalUpdateCache");
        }
        ...
        public override IStoreResults DoGlobalPreLocalExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateMappingOperation, IStoreResults>(this, "DoGlobalPreLocalExecute");
        }
        ...
        public override IStoreResults DoLocalSourceExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateMappingOperation, IStoreResults>(this, "DoLocalSourceExecute");
        }
        ...
        public override IStoreResults DoLocalTargetExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateMappingOperation, IStoreResults>(this, "DoLocalTargetExecute");
        }
        ...
        public override StoreConnectionInfo GetStoreConnectionInfo()
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateMappingOperation, StoreConnectionInfo>(this, "GetStoreConnectionInfo");
        }
        ...
        public override void HandleDoGlobalPostLocalExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "HandleDoGlobalPostLocalExecuteError");
        }
        ...
        public override void HandleDoGlobalPreLocalExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "HandleDoGlobalPreLocalExecuteError");
        }
        ...
        public override void HandleDoLocalSourceExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "HandleDoLocalSourceExecuteError");
        }
        ...
        public override void HandleDoLocalTargetExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "HandleDoLocalTargetExecuteError");
        }
        ...
        public override void HandleUndoGlobalPostLocalExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "HandleUndoGlobalPostLocalExecuteError");
        }
        ...
        public override void HandleUndoGlobalPreLocalExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "HandleUndoGlobalPreLocalExecuteError");
        }
        ...
        public override void HandleUndoLocalSourceExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "HandleUndoLocalSourceExecuteError");
        }
        ...
        public override void HandleUndoLocalTargetExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubUpdateMappingOperation>(this, "HandleUndoLocalTargetExecuteError");
        }

        /// <summary>
        /// Initializes a new instance of type StubUpdateMappingOperation
        /// </summary>
        ...
        public override IStoreResults UndoGlobalPostLocalExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateMappingOperation, IStoreResults>(this, "UndoGlobalPostLocalExecute");
        }
        ...
        public override IStoreResults UndoGlobalPreLocalExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateMappingOperation, IStoreResults>(this, "UndoGlobalPreLocalExecute");
        }
        ...
        public override IStoreResults UndoLocalSourceExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateMappingOperation, IStoreResults>(this, "UndoLocalSourceExecute");
        }
        ...
        public override IStoreResults UndoLocalTargetExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubUpdateMappingOperation, IStoreResults>(this, "UndoLocalTargetExecute");
        }
    }
}
