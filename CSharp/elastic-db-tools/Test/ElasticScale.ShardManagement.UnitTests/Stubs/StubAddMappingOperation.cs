    ...
    internal class StubAddMappingOperation : AddMappingOperation
    {
        ...
        protected override ShardManagementErrorCategory ErrorCategory
        {
            get
            {
                ...
                return this.InstanceBehavior.Result<StubAddMappingOperation, ShardManagementErrorCategory>(this, "get_ErrorCategory");
            }
        }
        ...
        protected override ShardLocation ErrorSourceLocation
        {
            get
            {
                ...
                return this.InstanceBehavior.Result<StubAddMappingOperation, ShardLocation>(this, "get_ErrorSourceLocation");
            }
        }
        ...
        protected override ShardLocation ErrorTargetLocation
        {
            get
            {
                ...
                return this.InstanceBehavior.Result<StubAddMappingOperation, ShardLocation>(this, "get_ErrorTargetLocation");
            }
        }
        ...
        protected override void Dispose(bool disposing)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubAddMappingOperation>(this, "Dispose");
        }
        ...
        public override IStoreResults DoGlobalPostLocalExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubAddMappingOperation, IStoreResults>(this, "DoGlobalPostLocalExecute");
        }
        ...
        public override void DoGlobalPostLocalUpdateCache(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubAddMappingOperation>(this, "DoGlobalPostLocalUpdateCache");
        }
        ...
        public override IStoreResults DoGlobalPreLocalExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubAddMappingOperation, IStoreResults>(this, "DoGlobalPreLocalExecute");
        }
        ...
        public override IStoreResults DoLocalTargetExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubAddMappingOperation, IStoreResults>(this, "DoLocalTargetExecute");
        }
        ...
        public override StoreConnectionInfo GetStoreConnectionInfo()
        {
            ...
            return this.InstanceBehavior.Result<StubAddMappingOperation, StoreConnectionInfo>(this, "GetStoreConnectionInfo");
        }
        ...
        public override void HandleDoGlobalPostLocalExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubAddMappingOperation>(this, "HandleDoGlobalPostLocalExecuteError");
        }
        ...
        public override void HandleDoLocalSourceExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubAddMappingOperation>(this, "HandleDoLocalSourceExecuteError");
        }
        ...
        public override void HandleDoLocalTargetExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubAddMappingOperation>(this, "HandleDoLocalTargetExecuteError");
        }
        ...
        public override void HandleUndoGlobalPostLocalExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubAddMappingOperation>(this, "HandleUndoGlobalPostLocalExecuteError");
        }
        ...
        public override void HandleUndoGlobalPreLocalExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubAddMappingOperation>(this, "HandleUndoGlobalPreLocalExecuteError");
        }
        ...
        public override void HandleUndoLocalSourceExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubAddMappingOperation>(this, "HandleUndoLocalSourceExecuteError");
        }
        ...
        public override void HandleUndoLocalTargetExecuteError(IStoreResults result)
        {
            ...
            if (action1 != null)
                ...
                this.InstanceBehavior.VoidResult<StubAddMappingOperation>(this, "HandleUndoLocalTargetExecuteError");
        }
        ...
        public override ShardManagementException OnStoreException(StoreException se, StoreOperationState state)
        {
            ...
            return this.InstanceBehavior.Result<StubAddMappingOperation, ShardManagementException>(this, "OnStoreException");
        }
        ...
        public override IStoreResults UndoGlobalPostLocalExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubAddMappingOperation, IStoreResults>(this, "UndoGlobalPostLocalExecute");
        }
        ...
        public override IStoreResults UndoGlobalPreLocalExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubAddMappingOperation, IStoreResults>(this, "UndoGlobalPreLocalExecute");
        }
        ...
        public override IStoreResults UndoLocalSourceExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubAddMappingOperation, IStoreResults>(this, "UndoLocalSourceExecute");
        }
        ...
        public override IStoreResults UndoLocalTargetExecute(IStoreTransactionScope ts)
        {
            ...
            return this.InstanceBehavior.Result<StubAddMappingOperation, IStoreResults>(this, "UndoLocalTargetExecute");
        }
    }
}
