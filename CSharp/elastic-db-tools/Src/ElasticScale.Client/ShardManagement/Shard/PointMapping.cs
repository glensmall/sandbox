...
namespace Microsoft.Azure.SqlDatabase.ElasticScale.ShardManagement
{
    ...
    /// </summary>
    /// <typeparam name="TKey">Type of the key (point).</typeparam>
    public sealed class PointMapping<TKey> : IShardProvider<TKey>, ICloneable<PointMapping<TKey>>, IMappingInfoProvider
    {
        /// <summary>
        ...
        internal PointMapping(ShardMapManager manager, PointMappingCreationInfo<TKey> creationInfo)
        {
            ...
            this.StoreMapping = new DefaultStoreMapping(
                Guid.NewGuid(),
                creationInfo.Shard,
                creationInfo.Key.RawValue,
                null,
                (int)creationInfo.Status);

            this.Key = creationInfo.Key;
        ...
        {
            return StringUtils.FormatInvariant("P[{0}:{1}]", this.Id, this.Key);
        }
        ...
        /// The key value. 
        /// </summary>
        TKey IShardProvider<TKey>.Value
        {
            get
            {
                return this.Value;
        ...
        {
            return new PointMapping<TKey>(this.Manager, this.Shard.ShardMap, this.StoreMapping);
        }
